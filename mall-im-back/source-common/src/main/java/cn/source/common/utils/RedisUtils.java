...
public class RedisUtils {
    ...
    private static final RedissonClient CLIENT = SpringBean.getBean(RedissonClient.class);
...
//    }
     ...
     * @return true=设置成功；false=设置失败
     */
    public static boolean expire(final String key, final long size, final TimeUnit timeUnit) {
        RBucket rBucket = CLIENT.getBucket(key);
        return rBucket.expire(size, timeUnit);
    }
