...
import cn.source.common.enums.UserStatus;
...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails createLoginUser(SysUser user) {
        ...
        if (Objects.nonNull(schoolId) && Objects.nonNull(mallSchool)) {
            return new LoginUser(user.getUserId(), user.getDeptId(), schoolId, mallSchool.getSchoolName(), user, permissionService.getMenuPermission(user));
        }
