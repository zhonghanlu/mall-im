...
public class MallOrderController extends BaseController {
     ...
     */
    @GetMapping("/own-list")
    public TableDataInfo ownList(MallOrder mallOrder) {
        startPage();
        List<MallOrder> list = mallOrderService.selectMallOwnOrderList(mallOrder);
        return getDataTable(list);
    }
...
//    @PreAuthorize("@ss.hasPermi('system:order:add')")
    ...
    public AjaxResult add(@RequestBody MallOrder mallOrder) {
        return AjaxResult.success(mallOrderService.insertMallOrder(mallOrder));
    }
